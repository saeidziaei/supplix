  ...
  return (
    <div className="w-full md:max-w-[300px]">
      ...
      <Select
        ...
        clearable
        placeholder={"Select"}
        className="!w-full md:max-w-[400px]  p-1 !rounded-xl !mt-1 *:!bg-[#E9EFF6] !bg-[#E9EFF6] !border-none  *:!border-none *:!rounded-2xl *:!outline-none hover:!shadow-lg transition duration-300"
      />
